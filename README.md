...
<p align="center"><img src="docs/demo.gif" alt="Loom's step-debugger: walk a multi-agent run — reasoning, tools, the exact context the model saw, and fork any turn live" width="900"></p>
<p align="center"><i>Step through any agent run — the reasoning, the tools, the exact context the model saw, and fork any turn live.</i></p>
